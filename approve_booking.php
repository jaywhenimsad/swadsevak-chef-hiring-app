...
if ($_SERVER["REQUEST_METHOD"] === "GET") {
    ...
    // Perform approval by updating the status of the booking to 'confirmed'
    $update_query = "UPDATE booking SET status = 'confirmed' WHERE booking_id = $bookingId";
    if (mysqli_query($conn, $update_query)) {
        // Redirect to chefprofile.php
